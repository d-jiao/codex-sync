...
make install-launchd    # install + register the daily launchd agent (pull then push)
...
└── trash/       # files pull removed locally, one batch dir per run
